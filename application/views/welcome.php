...
<body>
	...
	function show_content($param){
		...
		$title = $(this).data('original-title');
                ...
                <div class="clearfix">
                    <div class="pull-left">
                        <form method="get" action="<?php echo $this->config->item('redmine_url');?>" style="display:inline" target="_blank">
                            ...
                            <input type="hidden" name="issue[assigned_to_id]" value="<?php echo $this->config->item('redmine_assigne_id');?>"/>
		...
		<div class="well" style="padding:20px;">`+nl2br($message)+`</div>`;
		return $content;
	}
	$('.pop').popover(
